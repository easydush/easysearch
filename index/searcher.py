...
class BooleanSearch:
    ...
    def file_to_dict(self):
        ...
        d['full_pages'] = [str(i) for i in range(1, 201)]
        d['none_pages'] = []
    ...
    def search(self, search_string):
        try:
            ...
            result = sorted([int(i) for i in list(eval(' '.join(search_string)))])
            return result
...
if __name__ == '__main__':
    ...
    result = boolean_search.search(str(input('Type your search query:\n')))
    print(f'Result: {result}' if result else 'No index were found')
